 ...
 * @author misskabu
 */
public class SalesDetails_DeleteById implements ISQLExecutable {

	private Long id;
	final String SQL = "delete from sales_detail where id = ?"; 
	
	public SalesDetails_DeleteById(long id){
		this.id = id;
	}
	@Override

...
public class Sales_Insert implements ISQLExecutable {
	...
	public void executeQuery(Connection con) {
			...
			ps.setString(10,this.distribute_sale);
			ps.setString(11, this.distribute_design);
			ps.setString(12, this.distribute_coding);
			ps.setString(13, this.distribute_system);
			ps.setLong(14,this.distribute_sale_price);
			ps.setLong(15, this.distribute_design_price);
			ps.setLong(16, this.distribute_coding_price);
			ps.setLong(17, this.distribute_system_price);
			
	
			ps.setString(18,this.created_at);

...
public class Sales_Insert implements ISQLExecutable {
	...
	final String SQL = "insert into sales (name,status_id,customer_id,genres_id,invoice_status,memo,income_date,"
			+ "billing_date,distribute_sale,distribute_sale,distribute_coding,distribute_system,"
	...
	public Sales_Insert(String name,Long status_id,Long customer_id,Long genres_id,String invoice_status,
			String memo,String income_date,String billing_date,String distribute_sale,String distribute_coding,
			String distribute_design,String distribute_system,Long distribute_sale_price,Long distribute_design_price,
